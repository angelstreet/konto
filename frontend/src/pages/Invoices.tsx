  ...
  return (
    <div>
      <div className="flex items-center justify-between gap-2 mb-2 h-10">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            ...
            className={`hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium flex-shrink-0 transition-colors ${
              scanDone
      ...
      {!driveStatus?.connected && (
        <div className="hidden md:flex bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-4 text-sm text-yellow-300 items-center justify-between gap-3">
